...
class LocalisationExplanationViewController: UIViewController {
    ...
    let greenImageView: UIImageView = UIImageView(image: UIImage(named: "localisations-green-light", in: .module, compatibleWith: nil))
    
    let amberLabel: UILabel = UILabel()
    let amberImageView: UIImageView = UIImageView(image: UIImage(named: "localisations-amber-light", in: .module, compatibleWith: nil))
    
    let redLabel: UILabel = UILabel()
    let redImageView: UIImageView = UIImageView(image: UIImage(named: "localisations-red-light", in: .module, compatibleWith: nil))
    ...
    override func viewDidLoad() {
        ...
        moreButton.setImage(UIImage(named: "localisations-morebutton", in: .module, compatibleWith: nil), for: .normal)

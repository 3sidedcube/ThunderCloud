...
open class AnnularPlayButton: UIView {
	...
	let lightView: UIImageView = UIImageView(image: UIImage(named: "TSCAnnularPlayButton", in: .module, compatibleWith: nil))
	...
	let playView: UIImageView = UIImageView(image: UIImage(named: "TSCAnnularPlayButton-play", in: .module, compatibleWith: nil))

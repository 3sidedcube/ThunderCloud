...
open class StandardGridItem: GridItem {
	...
	public override var collectionCellClass: AnyClass? {
		return StandardGridItemCell.self
	}
	
	public override func configure(cell: UICollectionViewCell, at indexPath: IndexPath, in tableViewController: CollectionViewController) {

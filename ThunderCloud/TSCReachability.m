...
#pragma unused (target, flags)
	...
	NSCAssert([(__bridge NSObject*) info isKindOfClass: [TSCReachability class]], @"info was wrong class in ReachabilityCallback");

    TSCReachability* noteObject = (__bridge TSCReachability *)info;
...
{
	TSCReachability* returnValue = NULL;
